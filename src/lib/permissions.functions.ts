...
export const KNOWN_PERMISSIONS: { key: string; label: string; description: string; group: string }[] = [
  ...
  { key: "view.painel_cs", label: "Acessar Painel de CS", description: "Tela executiva do pipe Pipefy 'Onboarding Cliente' — funil, gargalos e tempo de ciclo do onboarding pós-venda.", group: "Acesso" },
